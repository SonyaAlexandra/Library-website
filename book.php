...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['addButton'])) {
    ...
    if ($photoError === UPLOAD_ERR_OK) {
        $uploadDir = 'C:\xampp\htdocs\libraryhub\images\book'; 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['deleteButton'])) {
    ...
    if ($isReturned == 1) {
        ...
        echo '<div class="alert alert-warning alert-dismissible fade show mb-0" role="alert">
            The book cannot be deleted because it has not been returned yet.
...
<body>
    ...
    echo '<nav class="navbar navbar-expand-lg" data-bs-theme="dark" id="navbar">
        <div class="container">
            <a href="index.php" class="navbar-brand fs-1 fw-bold logo">Library Readwise</a> 
